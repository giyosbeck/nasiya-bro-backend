...
from app.api.api_v1.endpoints import auth, users, products, auto_products, sales, auto_sales, loans, auto_loans, clients, files, transactions, magazines, reports, notifications, health
